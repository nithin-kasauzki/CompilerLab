...
static const char *const yytname[] =
{
  ...
  "'*'", "LETTER", "NUMBER", "'='", "';'", "'('", "')'", "$accept", "S",
  "stmts", "statement", "exp", "L", YY_NULLPTR
};
...
#line 65 "parser.y"
         {
start_ptr = (yyvsp[0].start_expr);
}
#line 1179 "y.tab.c"
    break;

  case 3: /* stmts: statement stmts  */
#line 69 "parser.y"
                       {
struct start_node* curr = (yyvsp[-1].start_expr);
}
#line 1187 "y.tab.c"
    break;
...
#line 73 "parser.y"
            {
    (yyval.start_expr) =(yyvsp[0].start_expr);
    (yyval.start_expr) = curr;
}
#line 1196 "y.tab.c"
    break;

  case 5: /* statement: L '=' exp ';'  */
#line 79 "parser.y"
                         {
 

struct start_node *curr = create_start_node(); curr->left = (yyvsp[-3].sub_expr);
curr->right = (yyvsp[-1].sub_expr);
(yyval.start_expr) = curr;
}
#line 1208 "y.tab.c"
    break;
  ...
  case 6: /* exp: exp '+' exp  */
#line 89 "parser.y"
                 { struct node* curr = make_node('+'); curr->left = (yyvsp[-2].sub_expr);
curr->right = (yyvsp[0].sub_expr);
(yyval.sub_expr) = curr;
}
#line 1217 "y.tab.c"
    break;
...
curr->left = (yyvsp[-2].sub_expr); curr->right = (yyvsp[0].sub_expr);
(yyval.sub_expr) = curr;
}
#line 1226 "y.tab.c"
    break;
...
#line 1246 "y.tab.c"
  ...
  case 10: /* exp: '(' exp ')'  */
#line 110 "parser.y"
              {(yyval.sub_expr) = (yyvsp[-1].sub_expr);}
#line 1252 "y.tab.c"
    break;
...
#line 112 "parser.y"
        {
    struct node* curr = make_node((char)(yyvsp[0].symbol));
    (yyval.sub_expr) = curr;
}
#line 1261 "y.tab.c"
    break;
